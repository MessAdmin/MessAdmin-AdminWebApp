...
<table border="0" style="border-spacing: 0.33em;">
	<tr>
		...
		<td>
			<span id="3xx" class="infoballoonable">
			<format:message key="3xx">
		...
		<td>
			<span id="4xx" class="infoballoonable">
			<format:message key="4xx">
			...
			<div id="4xx-infoballoon" class="infoballoon">
				<format:message key="403">
